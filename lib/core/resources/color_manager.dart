...
class ColorManager {
  ...
  // ===== Primary Colors =====
  static const Color primary = Color(0xFFE5D4D2);
  ...
  static const Color scaffolLdight = Color(0xFFFFFFFF);
  ...
  static const Color hintText = Color(0xFFFFFFFF);
  // ===== Neutral Colors =====
  ...
  static const Color splash_screen = Color(0xFF294889);
}
