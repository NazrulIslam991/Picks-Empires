class RouteName {
  ...
  static const String onBordingScreen = "/onBordingScreen"; // OnBording Screen
  static const String logInScreen = "/logInScreen"; // Login Screen
  static const String signUpScreen = "/signUpScreen"; // sign Up Screen
